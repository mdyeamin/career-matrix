...
const currencyIcons = {
  ...
  bdt: (
    <HiMiniCurrencyBangladeshi className="text-purple-400 text-lg shrink-0" />
  ),
};
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-6">
        ...
        <p className="text-default-400 text-sm">
          The job listing you are looking for might have expired or been
          removed.
        </p>
      </div>
    );
            ...
            <div className="flex items-center gap-4 sm:gap-5">
              ...
              <div className="flex flex-col gap-1 min-w-0">
                ...
                <div className="flex items-center gap-2 text-sm text-purple-400 font-medium">
                  ...
                  <span className="text-default-400 font-light">
                    {companyLocation}
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-[#1c1c1e] rounded-2xl border border-[#2c2c2e]">
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-xs text-default-400 font-light">
                  Location
                </span>
